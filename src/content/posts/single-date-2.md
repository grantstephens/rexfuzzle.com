...
The solution seems simple. Only allow one ongoing conversation at a time. You can only send a message to somebody if they have no other ongoing conversations. If you're talking to somebody and get a bit bored you have a choice to make, either keep on being a bit bored and see if something works out, or end the conversation and wait for a new message or send one to somebody yourself.
